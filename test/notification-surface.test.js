...
test('Notification action hints are advisory only',async ()=>{
...
test('HTML and JSON render the same already-filtered item facts and HTML escapes previews',async ()=>{
...
test('Notification renderers are pure presentation modules with no storage imports',async ()=>{
