...
test('Notification ID is deterministic for recipient source event and rule',async ()=>{
...
test('fold starts at issued and allows exactly one acknowledgment',async ()=>{
...
test('issued identity fields are immutable across later events',async ()=>{
...
test('Notification issued payload forbids source content copies and non-private visibility',async ()=>{
