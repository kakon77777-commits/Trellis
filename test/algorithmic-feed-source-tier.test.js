...
test('self publication has highest source tier even when community scoped', async () => {
...
test('subscription outranks follow for the same unscoped author without stacking', async () => {
...
test('community-scoped publication uses community source instead of author follow strength', async () => {
...
test('subject-involved collaboration is strongest activity source tier', async () => {
...
test('subscribed actor activity outranks followed actor activity', async () => {
...
test('visible community membership activity gets community activity tier', async () => {
...
test('source tier cannot be invented from an item outside the supplied visible source graph', async () => {
