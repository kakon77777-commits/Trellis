...
test('subject can request own discovery', async () => {
  assert.deepEqual(
...
test('representative can read subject discovery without becoming subject', async () => {
  assert.deepEqual(
...
test('unrelated viewer cannot request personalized discovery for public actor', async () => {
  assert.throws(
...
test('viewer identity key is stable and order-insensitive for represented actors', async () => {
