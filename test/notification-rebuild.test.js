...
test('notifications_current is disposable and exactly rebuildable from H_notification',async ()=>{
 ...
 (await projectNotificationStream(db,store,'notification:n1'));
 ...
 (await rebuildNotificationProjection(db,store));
