...
test('Preference projection can be destroyed and rebuilt exactly from canonical history',async ()=>{
  ...
  (await projectPreferenceStream(db,store,pid));
  ...
  (await rebuildPreferenceProjection(db,store));
